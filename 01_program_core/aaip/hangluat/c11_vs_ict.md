...
content_hash: c546147dcc1a6bf0
file_role: c11_vs_ict
lang: en
...
source_id: sobirovs_c11_vs_ict
source_type: law_firm
source_url: https://sobirovs.com/resources/c11-vs-ict-canada/
topic: work_permits
version: '1.0'
---
...
### ICT Work Permit
[The ICT work permit](https://sobirovs.com/business-immigration/intra-company-transfer-program/) applies to multinational companies transferring employees to Canada. The employee must usually have worked for the foreign company for at least one year during the previous three years and must hold an executive, senior managerial, or specialized knowledge role.
...
## Application Process
  1. Evaluate the company’s expansion strategy and determine whether C11 or ICT is appropriate.
  2. Prepare supporting documentation, including corporate records and business plans.
  3. Submit the work permit application to Immigration, Refugees and Citizenship Canada.
  4. Immigration officers review eligibility and supporting evidence.
  5. Upon approval, the applicant may travel to Canada and begin operating the business.
...
**One important planning note:** if your ICT is tied to a specific employer and you intend to switch to C11, you should have your business structure and documentation in order _before_ filing — IRCC will assess your C11 application on its own merits, independent of your ICT history.
If you are considering a program switch, [get legal advice before filing](https://calendly.com/sobirovslaw/strategy-meeting). The timing, documentation, and eligibility requirements differ enough between programs that a misstep can result in gaps in work authorization.
## Key Takeaways
...
[](https://calendly.com/sobirovslaw/strategy-meeting)[ ![Book a consultation with Sobirovs Law Firm for expert immigration assistance, featuring a cityscape background and a prominent call-to-action button.](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%201233%20146'%3E%3C/svg%3E) ](https://calendly.com/sobirovslaw/strategy-meeting)