...
source_id: nzaewv_green_list
source_type: official
source_url: https://www.immigration.govt.nz/visas/straight-to-residence-visa/
topic: eligibility
version: '1.0'
---
...
[Apply online](https://online.immigration.govt.nz/)
...
[While you are in New Zealand](https://immigration.govt.nz/visas/straight-to-residence-visa/#e2516)
...
- be with an
- be a Tier 1 job on the Green List
- pay at least the rate specified for your Green List Tier 1 job, or the current median wage if a pay rate is not specified for your job
- be
  , and
- be permanent or fixed-term for at least 12 months (from when you apply), or a contract or continuous contracts for at least 6 months.

[Accredited employer list](/work/requirements-for-work-visas/approved-employers/accredited-employer-list/)

#### About Green List jobs
...
You must also meet the Green List requirements for your job. Requirements can include needing to be paid a certain amount or have a specific registration, professional membership, or qualification.
...
- the rate specified for your Green List Tier 1 job, or
- NZD $35.00 an hour (the 2025 median wage) if a wage rate is not specified for your Green List job.

[Wage rates for visas](/work/requirements-for-work-visas/wage-rates-for-work-visas/)

Documents you can provide to show what you earn include:
...
If your job will be based on a contract for services, you may have additional pay or skill requirements you need to meet. Check the Green List to see if there are any other requirements for your job — if there are, they will be listed under the 'Green List requirements' for your job.

[Green list roles — jobs we need people for in New Zealand](/work/requirements-for-work-visas/green-list-occupations-qualifications-and-skills/green-list-roles-jobs-we-need-people-for-in-new-zealand/)

If your job has a wage threshold for employment based on a contract for services, you will need evidence showing:

- you have 10 years of relevant experience, and
- you are paid at least the contract for services wage threshold.
...
You may need an
for qualifications gained outside New Zealand. If you need an IQA, you must apply and include the results in your visa application.
...
- 10 or younger, must get a medical examination, but do not need a chest X-ray unless we or your
  ask for one
...
1. 1
   ...
   **Note**
   ...
   If you need an
   for your overseas qualification, allow yourself enough time to get one.
...
3. 3
   ...
   **Note**
   ...
   [Interim Visa](https://immigration.govt.nz/visas/interim-visa/)
4. 4
   ...
   [Check your application progress](/process-to-apply/waiting-for-a-visa/check-your-application-progress/ "check your application progress ")

   We will email you when we make a decision.

   If we approve your application, we will give you an eVisa and send you a copy.

   [Visa labels and eVisas](/process-to-apply/once-you-have-a-visa/manage-your-visa-and-passport/using-evisas-and-visa-labels/ " Visa labels and eVisas")
...
[Permanent Resident Visa](https://immigration.govt.nz/visas/permanent-resident-visa/)

[Check or change your resident visa conditions](/live/resident-visas-to-live-in-new-zealand/check-or-change-your-resident-visa-conditions/)
...
[Transferring your visa to a new passport](/process-to-apply/once-you-have-a-visa/manage-your-visa-and-passport/transferring-a-visa-to-a-new-passport/ " Transferring your visa to a new passport")
...
After you have had a Straight to Residence Visa for 2 years in a row, you can apply for a Permanent Resident Visa.
...
[Requirements for NZ citizenship — New Zealand Government](https://www.govt.nz/browse/passports-citizenship-and-identity/nz-citizenship/requirements-for-nz-citizenship/ "Requirements for NZ citizenship — New Zealand Government")