...
content_hash: b5a0f082d1630ec3
file_role: ircc_completeness_check
lang: en
...
Applications are assessed for completeness up front. An application found to be incomplete should be rejected as per [section 10](http://laws-lois.justice.gc.ca/eng/regulations/SOR-2002-227/section-10.html) of the Immigration and Refugee Protection Regulations, and all fees associated with the application should be refunded to the applicant.
...
- the e-APR
- the [cost recovery fees](/en/immigration-refugees-citizenship/corporate/publications-manuals/operational-bulletins-manuals/fees/immigration/express-entry-electronic-application-permanent-residence.html)
- all [supporting documentation](#s03) to validate information contained in the applicant’s Express Entry profile and e-APR
...
- repaying all [fees](/en/immigration-refugees-citizenship/corporate/publications-manuals/operational-bulletins-manuals/fees/immigration/express-entry-electronic-application-permanent-residence.html) associated with the application (e.g., the cost recovery fee and the right of permanent residence fee, as applicable).
...
- a scan of the original document, or a scan of a [certified photocopy](/en/services/immigration-citizenship/helpcentre/glossary.html#certified_photocopy) of the original document

[**Apply for permanent residence: Documents for Express Entry**](/en/immigration-refugees-citizenship/services/immigrate-canada/express-entry/apply-permanent-residence/scan-upload-documents.html) explains how to meet these requirements.

## Mandatory documents for all applicants

The following documents are mandatory and must be provided by all applicants.

Applications that do not contain the following documents will be rejected as incomplete, and [fees](/en/immigration-refugees-citizenship/corporate/publications-manuals/operational-bulletins-manuals/fees/immigration/express-entry-electronic-application-permanent-residence.html) will be refunded accordingly.

### Medical examination confirmation

**Note:** Between October 1, 2023, and August 21, 2025, upfront [medical examinations were not required](/en/immigration-refugees-citizenship/services/immigrate-canada/express-entry/apply-permanent-residence.html) at the time of application for Express Entry. As the department transitions back to the upfront medical requirement, we expect to receive some applications in the interim without medical examinations. The processing office should not reject these applications as incomplete and should facilitate the application during this transition period.

If no IME was provided, processing offices should conduct an integrated search for any previously completed IMEs and associate the IME to the application accordingly. Processing offices should then review and apply the [temporary public policy (TPP)](/en/immigration-refugees-citizenship/corporate/mandate/policies-operational-instructions-agreements/public-policies/excempt-ime-2024.html), if the applicant is eligible. If no IME is found and the TPP cannot be applied, instructions to undergo an IME should be sent to the applicant.

Applications received on or after October 21, 2025, without an IME may be rejected as required.
...
- The [medical examination confirmation](/en/immigration-refugees-citizenship/services/application/medical-police/medical-exams/requirements-permanent-residents.html) iis required up front and must be valid at the time of application.
- The applicant must include either their unique medical identifier (UMI) number, or their unique immigration medical examination (IME) number in their e-APR.
- The applicant must provide a copy of either the information printout sheet or the IMM 1017B Upfront Medical Report form.

**Note:** A [TPP](/en/immigration-refugees-citizenship/corporate/mandate/policies-operational-instructions-agreements/public-policies/excempt-ime-2024.html) for in-Canada applicants is in place until October 5, 2029. If an applicant has completed an IME in the 5 years before submitting their Express Entry application, they are instructed to include the IME number (or the unique medical identifier number) from their previous IME in their current application. If the applicant is not eligible for the TPP, the processing office should send instructions for undergoing an IME to the applicant.

- Exceptions are made only in rare circumstances that are outside of the client’s control (for example, cancellation of the appointment by the panel physician at the last minute without time to reschedule).
...
Some countries will not issue police certificates to applicants, and instead will only communicate directly with the relevant Canadian authorities. In such cases, existing [IRCC procedures to obtain documentation](/en/immigration-refugees-citizenship/services/application/medical-police/police-certificates/how.html) should be followed.

The IRCC website provides instructions to applicants on [Where to obtain a police certificate](/en/immigration-refugees-citizenship/services/application/medical-police/where.html).
...
- To receive program-specific points for education, the applicant must either
  ...
  - obtain an [Educational Credential Assessment (ECA)](/en/immigration-refugees-citizenship/corporate/publications-manuals/operational-bulletins-manuals/permanent-residence/terms-definitions-related-permanent-residence.html) and provide the ECA reference number in their application, along with proof of the foreign educational credentials for which points are being claimed.
...
- Applicants must provide the [Designated Learning Institution (DLI)](/en/immigration-refugees-citizenship/services/study-canada/study-permit/prepare/designated-learning-institutions-list.html) number of the Canadian Institution where they completed their highest degree to be assigned points for their Canadian educational credentials.
...
To validate an applicant’s claim of having a [provincial or territorial certificate of qualification](/en/immigration-refugees-citizenship/corporate/publications-manuals/operational-bulletins-manuals/permanent-residence/terms-definitions-related-permanent-residence.html)
...
To confirm an applicant’s [qualifying offer of arranged employment](/en/immigration-refugees-citizenship/services/immigrate-canada/express-entry/documents/job-offer.html), to validate that the applicant meets program requirements and to screen for concerns of fraud
...
- If the there is an associated [Labour Market Impact Assessment (LMIA)](/en/immigration-refugees-citizenship/corporate/publications-manuals/operational-bulletins-manuals/permanent-residence/terms-definitions-related-permanent-residence.html) to the offer of employment, the LMIA number is requested as part of the application.
...
- The [IMM 5476 form (PDF, 648.31 KB)](/content/dam/ircc/migration/ircc/english/pdf/kits/forms/imm5476e.pdf) must be signed by the principal applicant and, if applicable, their spouse or common-law partner.
...
- The applicant must submit a Statutory Declaration of Common-Law Union form [[IMM 5409 (PDF, 636.51 KB)](/content/dam/ircc/migration/ircc/english/pdf/kits/forms/imm5409e.pdf)] and evidence of cohabitation for a period of at least 12 continuous months.
...
- Digital photos meeting [IRCC’s permanent resident card photo specifications (PDF, 614.24 KB)](/content/dam/ircc/migration/ircc/english/information/applications/guides/pdf/5445eb-e.pdf) must be provided.
...
- The [IMM 5475 form (PDF, 593.57 KB)](/content/dam/ircc/migration/ircc/english/pdf/kits/forms/imm5475e.pdf) must be signed by the applicant and, as applicable, their spouse or common-law partner if they also wish to release personal information to the same designated individual.
...
- This should be used to submit the Authority to Release Personal Information to a Designated Individual form [[IMM 5475 (PDF, 593.57 KB)](/content/dam/ircc/migration/ircc/english/pdf/kits/forms/imm5475e.pdf)], if applicable.
