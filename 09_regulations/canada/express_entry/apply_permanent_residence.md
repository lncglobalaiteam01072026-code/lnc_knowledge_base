...
content_hash: 99f842e300bb3e09
file_role: apply_permanent_residence
lang: en
last_updated: '2026-07-09'
priority_weight: 0.9
program: IRCC
retrieval_strategy: direct
source_id: ircc_ee_apply_permanent_residence
...
topic: ee_apply_permanent_residence
version: '1.0'
---

# Express Entry

- [Who can apply](/en/immigration-refugees-citizenship/services/immigrate-canada/express-entry/who-can-apply.html)
- [Check your score](/en/immigration-refugees-citizenship/services/immigrate-canada/express-entry/check-score.html)
- [Get your documents ready](/en/immigration-refugees-citizenship/services/immigrate-canada/express-entry/documents.html)
- [Create your profile](/en/immigration-refugees-citizenship/services/immigrate-canada/express-entry/create-profile.html)
- [Rounds of invitations](/en/immigration-refugees-citizenship/services/immigrate-canada/express-entry/rounds-invitations.html)
- [Apply for permanent residence](#)
- [After you apply](/en/immigration-refugees-citizenship/services/immigrate-canada/express-entry/after-apply.html)
- [If we approve your application](/en/immigration-refugees-citizenship/services/immigrate-canada/express-entry/application-approved.html)

# Apply for permanent residence

## On this page

1. [Fill out the application form](#form)
2. [Upload your documents](#documents)
3. [Pay the fees](#fees)
4. [Submit your application](#submit)
...
3. On the right-hand side of the row with “application type” as “permanent residency,” choose the blue “Continue application” button.

[Sign in to your IRCC secure account](/en/immigration-refugees-citizenship/services/application/account.html)
...
1. [Sign in to your account](/en/immigration-refugees-citizenship/services/application/account.html).
...
You may consider applying directly to a province or territory through the [Provincial Nominee Program](/en/immigration-refugees-citizenship/services/immigrate-canada/provincial-nominees/non-express-entry.html) or [find out about other options to immigrate to Canada](https://ircc.canada.ca/explore-programs/index.asp).
...
- [improve your score](/en/immigration-refugees-citizenship/services/immigrate-canada/express-entry/create-profile.html#wait)
...
If your situation (or that of your spouse or common-law partner) changes, you should [re-calculate your score](/en/immigration-refugees-citizenship/services/immigrate-canada/express-entry/check-score.html) before applying online for permanent residence.

If your recalculated score is less than the lowest score in your [round of invitations](/en/immigration-refugees-citizenship/services/immigrate-canada/express-entry/rounds-invitations.html), you should decline the invitation. If you decide to apply anyway, we may:
...
- you no longer have a [valid job offer](/en/immigration-refugees-citizenship/services/immigrate-canada/express-entry/documents/job-offer.html)
...
If your work permit expires before you apply, **your score may drop**. For example, this could happen if you got [points for a job offer](/en/immigration-refugees-citizenship/services/immigrate-canada/express-entry/documents/job-offer.html) based on the expired work permit.
...
- [Update your Express Entry profile](https://ircc.canada.ca/english/helpcentre/answer.asp?qnum=1005&top=29) to show the change in your work status.

## 2. Upload your documents

### Get the right documents

You’ll need to upload copies of the [documents you used for your profile](/en/immigration-refugees-citizenship/services/immigrate-canada/express-entry/documents.html). The system gives you a **personalized** document checklist once you’ve completed the online form.

Most applicants will also need to upload:

- [police certificates](/en/immigration-refugees-citizenship/services/immigrate-canada/express-entry/documents/police-certificates.html)
- [proof of funds](/en/immigration-refugees-citizenship/services/immigrate-canada/express-entry/documents/proof-funds.html)
- birth certificate, if you’re declaring dependent children
- [Use of a Representative form [IMM 5476]](/en/immigration-refugees-citizenship/services/application/application-forms-guides/imm5476.html), if you’ve hired a representative
- [common-law union form [IMM 5409]](/en/immigration-refugees-citizenship/services/application/application-forms-guides/imm5409.html), if you’ve declared your marital status as “common-law”
...
- [authority to release personal information to a designated individual form [IMM 5475]](/en/immigration-refugees-citizenship/services/application/application-forms-guides/imm5475.html)
...
- an English or French translation that’s:
  - stamped by a [certified translator](#translator-popup)
  ...
  - **or**
  - accompanied by an [affidavit](#affidavit-popup) from the person who completed the translation
...
- **and**
- a scan of the original document, or a scan of a [certified photocopy](#photocopy-popup) of the original document that the translator worked from
...
A certified photocopy is a photocopy of an original document that is readable and certified as a true copy of the original by an authorized person.

The authorized person compares the documents and marks on the photocopy:
...
Gather all the documents on your checklist and make electronic copies using a scanner or camera. Make sure you use [one of the formats we accept](https://ircc.canada.ca/english/helpcentre/answer.asp?qnum=1124&top=23).

Once you have your documents ready, upload them in your document checklist.

### Get a medical exam, if you need one

An [immigration medical exam (IME)](/en/immigration-refugees-citizenship/services/application/medical-police/medical-exams/requirements-permanent-residents.html) from a [panel physician](/en/services/immigration-citizenship/helpcentre/glossary.html#panel_physician) is a requirement for permanent residence. Your [family members](/en/services/immigration-citizenship/helpcentre/glossary.html#family_members) must also have a medical exam even if they aren’t coming with you.

If you've never had a medical exam

If you’ve never had a medical exam before, you should get one after you’re invited to apply. Your exam results must be valid when you:

- submit your application for permanent residence and
- get permanent residence in Canada

It’s a good idea to get the exam **as close as possible to the date you apply online**.

#### Get an exam

We don’t send you any documents to take the exam.

To get one, contact a [panel physician](https://secure.cic.gc.ca/PanelPhysicianMedecinDesigne/en/Home) directly. When the panel physician gives you a medical exam, they’ll give you an:
...
**Important:** Don’t book more than one IME appointment.
...
If you have already completed an IME as part of a previous application in the past 5 years (for example, to work or study) and are currently living in Canada, you **may not need to complete another one** when you apply for permanent residence.
...
Please **provide a copy of one of these documents** or your IME number (or unique medical identifier number) from your previous medical exam when you apply online.

If we cannot use your old results, we’ll send you instructions on how to get your [medical exam](/en/immigration-refugees-citizenship/services/application/medical-police/medical-exams/requirements-permanent-residents.html) done after you submit your application.
...
[Find out how much you can expect to pay](https://ircc.canada.ca/english/information/fees/fees.asp#economic)
...
- didn’t pay your [Right of permanent residence fee](https://eservices.cic.gc.ca/epay/order.do?category=8&lang=en) when you applied, or
- want to [add a spouse or dependent child to your application](https://eservices.cic.gc.ca/epay/order.do?category=10070) (marriage or birth of a child)
...
- pay your processing fee and [biometrics fee](/en/immigration-refugees-citizenship/campaigns/biometrics/facts.html)
...
- [Next: After you apply](/en/immigration-refugees-citizenship/services/immigrate-canada/express-entry/after-apply.html#wb-cont)
