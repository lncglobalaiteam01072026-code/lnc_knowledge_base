...
content_hash: 522d92a896f28fda
file_role: pdi_employer_specific_wp
lang: en
last_updated: '2026-07-09'
priority_weight: 1
program: IRCC
retrieval_strategy: direct
source_id: pdi_employer_specific_wp
source_url: https://www.canada.ca/en/immigration-refugees-citizenship/corporate/publications-manuals/operational-bulletins-manuals/temporary-residents/foreign-workers/eligibility/employer-specific-labout-market-impact-assessment-exemptions.html
topic: pdi_employer_specific_wp
version: '1.0'
---

Employer-specific work permits – General processing – International Mobility Program - Canada.ca
...
- [Français
  fr](/fr/immigration-refugies-citoyennete/organisation/publications-guides/bulletins-guides-operationnels/residents-temporaires/travailleurs-etrangers/admissibilite/employeur-precis-dispense-etude-impact-marche-travail.html)
...
The instructions on this page should be reviewed in conjunction with the applicable [LMIA-exemption](/en/immigration-refugees-citizenship/corporate/publications-manuals/operational-bulletins-manuals/temporary-residents/foreign-workers/eligibility/employer-specific-labout-market-impact-assessment-exemptions.html) instructions. In addition, the following instruction pages should be reviewed:
...
- [Decision making: Standard of review and process for making a reasonable decision](/en/immigration-refugees-citizenship/corporate/publications-manuals/operational-bulletins-manuals/service-delivery/decision-standard-review.html)

## On this page

- [No offer of employment information or employer compliance fee submitted](#t1)
  - [Employers exempt from the compliance regime](#t1.1)
  - [Employers exempt from the employer compliance fee](#t1.2)
- [Employer Portal submission](#t2)
  - [Exemption from the requirement to obtain an LMIA](#t2.1)
  - [Job details](#t2.2)
  - [See screenshot](#a1-screen)
  - [See screenshot](#a2-screen)
- [Matching the offer of employment to the work permit application](#t3)
  - [If the “Employment Details” view tab does not automatically populate](#t3.1)
  - [Verifying if the offer of employment number is valid](#t3.2)
- [Alternate submission [IMM 5802]](#t4)
  - [Confirmation by the processing officer that alternate submission was authorized](#t4.1)
  - [Allocation of the employer payment receipt number](#t4.2)
- [Reviewing the offer of employment information](#t5)
  - [Check for multiple job locations](#t5.1)
  - [Main duties of the job must align with NOC selected](#t5.2)
  - [Variance in duties](#t5.3)
- [Changes to the offer by the employer after matching to the application](#t6)
- [Completeness of the offer of employment](#t7)
  - [Information in application conflicts with applicant’s documents](#t7.1)
  - [Port of entry (POE) tip](#t7.2)
- [Manual un-matching by officers](#t8)
- [Changes between the offer of employment and the work permit application](#t9)
  - [Changes authorized for the processing officer without contact with the employer](#t9.1)
- [Concerns regarding the genuineness of the offer of employment [R200(5)]](#t11)
- [When to refer a concern to Integrity Risk management Branch (IRM)](#t10)
- [Refusals, withdrawals and refunds](#t12)
  - [Refusal of the work permit application](#t12.1)
    - [POE tip](#t12.1.1)
  - [Refusals where employer was exempted from paying the compliance fee](#t12.2)
  - [Withdrawal of the offer of employment before work permit issuance](#t12.3)
  - [Withdrawal when work permit application has been matched, but not yet approved (no letter of introduction or work permit issued)](#t12.4)
- [POE considerations](#t13)
  - [Work permit application approved at a visa office (letter of introduction provided) but work permit not issued (POE)](#t13.1)

For LMIA-exempt, employer-specific work permit applications, the employer is required under section 209.11 of the Immigration and Refugee Protection Regulations (IRPR) to use the [Employer Portal](/en/immigration-refugees-citizenship/corporate/partners-service-providers/employer-portal.html) to submit the offer of employment directly to Immigration, Refugees and Citizenship Canada (IRCC) and pay the $230 compliance fee **before** the foreign national makes an application for a work permit.
...
For inspection purposes relating to the employment agreement requirement, the [Employer Compliance Inspection](/en/immigration-refugees-citizenship/corporate/publications-manuals/operational-bulletins-manuals/temporary-residents/foreign-workers/work-without-permit/employer-compliance-inspections.html) provides further information on this topic.
...
A work permit application must be **refused** under paragraph [R200(3)(f.1)](https://laws-lois.justice.gc.ca/eng/regulations/SOR-2002-227/section-200.html) if the employer is not exempt and has not done the following:

- paid the employer compliance fee, as per section [R303.1](https://laws-lois.justice.gc.ca/eng/regulations/SOR-2002-227/section-303.1.html) [unless the employer has been exempted from paying the fee under subsection R303.1(5) or [R303.2(2)](https://laws-lois.justice.gc.ca/eng/regulations/SOR-2002-227/section-303.2.html)]
...
- foreign governments
- international organizations recognized under the [Foreign Missions and International Organizations Act](https://laws-lois.justice.gc.ca/eng/acts/f-29.4/index.html)
- foreign missions (embassies or consular generals) in Canada where the foreign national is [not accredited by Global Affairs Canada](/en/immigration-refugees-citizenship/corporate/publications-manuals/operational-bulletins-manuals/temporary-residents/foreign-workers/work-without-permit/foreign-representatives/government-officials-accredited-canada.html)
- [international bridge or tunnel authorities with foreign employees working on Canadian soil](/en/immigration-refugees-citizenship/corporate/publications-manuals/operational-bulletins-manuals/temporary-residents/foreign-workers/compliance-exempt-employers/bridge.html)
...
Officers should follow the processing instructions for [exemptions from the compliance regime](/en/immigration-refugees-citizenship/corporate/publications-manuals/operational-bulletins-manuals/temporary-residents/foreign-workers/compliance-exempt-employers.html).

### Employers exempt from the employer compliance fee

Some [employers might be exempt](/en/immigration-refugees-citizenship/corporate/publications-manuals/operational-bulletins-manuals/temporary-residents/foreign-workers/compliance-exempt-employers.html) from paying the employer compliance fee under subsections R303.1(5). Despite the fee exemption, these employers must still submit the offer of employment to IRCC, as per section R209.11.
...
To ensure that the requirements of paragraph [R200(3)(f.1)](https://laws-lois.justice.gc.ca/eng/regulations/SOR-2002-227/section-200.html) are met for an employer-specific, LMIA-exempt work permit, officers must confirm that the offer of employment has been submitted **and** that employer compliance fee has been paid or the employer has provided proof of fee exemption (found in the “eDocs” view tab in the “Organization” tab).
...
1. Navigate to the **Organizations & Entities** screen.
2. Click the **Query** button.
3. Enter the employer’s organization identification number in the **Organization ID** field and click **Search**.
4. The information can be found under the **Offer of Employment — Attachments** view.

[See screenshot](#a1) ![Offer of Employment - Attachments view](/content/dam/ircc/images/corporate/publications-manuals/operational-bulletins-manuals/temporary-residents/foreign-workers/eligibility/GCMS01-en.jpg)

#### Job details

1. From the application screen, click on the **Employment Details — LMIA Exempt** view.
2. The information can be found under the **Requirements Exemption Met** field.

[See screenshot](#a2) ![Requirements Exemption Met field](/content/dam/ircc/images/corporate/publications-manuals/operational-bulletins-manuals/temporary-residents/foreign-workers/eligibility/GCMS02-en.jpg)
...
Officers can review the information in the “Employment Details — LMIA-exempt” tab on the IMM screen and confirm that it is fully and accurately complete [[R209.11](http://laws-lois.justice.gc.ca/eng/regulations/SOR-2002-227/section-209.11.html)]. Officers can also review the “Fees” tab to confirm that the [employer compliance fee](/en/immigration-refugees-citizenship/corporate/publications-manuals/operational-bulletins-manuals/fees/immigration/work-permit-r196-r299-1.html) (if applicable) has been paid.
...
- if satisfied of the foreign national’s identity, make the change as noted in the [Changes authorized for the processing officer without contact with the employer](#t9.1) section, under “Passport number”.
...
In rare situations, employers who experience technical difficulties that cannot be resolved by IRCC within the service standard or who are unable, because of a physical or mental disability [[R209.11(3)](http://laws-lois.justice.gc.ca/eng/regulations/SOR-2002-227/section-209.11.html)], to provide the information using the electronic system **may be authorized by the department** to submit the “Offer of Employment to a Foreign National Exempt from a Labour Market Impact Assessment (LMIA)” form [IMM 5802] using an [alternate method](/en/immigration-refugees-citizenship/corporate/publications-manuals/operational-bulletins-manuals/temporary-residents/foreign-workers/eligibility/employer-specific-labout-market-impact-assessment-exemptions.html#confirm).
...
The IMM 5802 form must never be used by employers without the permission of IRCC. Employers must always contact the [Employer Portal](mailto:CIC.EmployerPortal-Portaildelemployeur.CIC@cic.gc.ca) mailbox first to provide information on their technical issue or disability in order to obtain authorization for alternate submission. This requirement ensures consistent program integrity.
...
Once the existence of the Client Note has been verified, officers should review the information in the Offer of Employment to a Foreign National Exempt from a Labour Market Impact Assessment (LMIA)” form [IMM 5802] as per the instructions found in [Reviewing the offer of employment information](/en/immigration-refugees-citizenship/corporate/publications-manuals/operational-bulletins-manuals/temporary-residents/foreign-workers/eligibility/employer-specific-labout-market-impact-assessment-exemptions.html#t5).
...
Officers should review the information in the “Employment Details - LMIA-exempt” view (or the IMM 5802 form) to ensure that the offer of employment is complete, that the foreign national meets the requirements listed in the “Job Details” section (or the “Details of Job” section on the IMM 5802 form), that the offer meets [the genuineness requirements](/en/immigration-refugees-citizenship/corporate/publications-manuals/operational-bulletins-manuals/temporary-residents/foreign-workers/genuineness.html) in [subsection R200(5)](http://laws-lois.justice.gc.ca/eng/regulations/SOR-2002-227/section-200.html) and that the [employer is not ineligible](/en/immigration-refugees-citizenship/services/work-canada/employers-non-compliant.html) to hire a foreign worker.
...
- refuse the work permit application under paragraph [R200(3)(a)](https://laws-lois.justice.gc.ca/eng/regulations/SOR-2002-227/section-200.html), as the foreign national might not be able to conduct the duties in the offer
...
- check in the eDoc view tab to confirm if additional documents were uploaded by the employer as per [Explanation of exemption from the requirement to obtain a LMIA](#t2.1)
...
**Note:** In the [Employer Portal User Guide](/en/immigration-refugees-citizenship/corporate/partners-service-providers/employer-portal/user-guide.html), employers are told that they must fill in all fields in the offer forms. They may [upload additional documentation](#t2.1) if needed.
...
- [assess the work permit](/en/immigration-refugees-citizenship/corporate/publications-manuals/operational-bulletins-manuals/temporary-residents/foreign-workers/eligibility/steps-determine-work-assessment-work-permit-application.html) application as received and make the final decision
...
If the officer has concerns regarding the employer or the genuineness of the offer of employment, the officer may request further information directly from the employer as per the contact information supplied in the offer of employment. Subparagraph [R200(1)(c)(ii.1](https://laws-lois.justice.gc.ca/eng/regulations/SOR-2002-227/section-200.html)) provides officers with the authority to request information from employers without having to use the foreign national applicant as a conduit for that request.
...
- [Assessing the genuineness of the offer of employment on a work permit application](/en/immigration-refugees-citizenship/corporate/publications-manuals/operational-bulletins-manuals/temporary-residents/foreign-workers/genuineness.html) [[R200(5)](https://laws-lois.justice.gc.ca/eng/regulations/SOR-2002-227/section-200.html)]
- [Review of wages, occupation and working conditions provided to previous temporary workers](/en/immigration-refugees-citizenship/corporate/publications-manuals/operational-bulletins-manuals/temporary-residents/foreign-workers/wages-occupation-working-conditions.html)

**Important:** Subparagraph [R209.2(1)(b)(i)](https://laws-lois.justice.gc.ca/eng/regulations/SOR-2002-227/section-209.2.html) makes it a condition that **employers** demonstrate that any information they provided under subparagraph R200(1)(c)(ii.1) or section [R209.11](https://laws-lois.justice.gc.ca/eng/regulations/SOR-2002-227/section-209.11.html) **is accurate**. Information provided by or requested from the foreign national is not “provided by the employer” and is therefore not included in the information that can be inspected for accuracy. The employer’s contact information should be included in the offer of employment form provided by the employer, as per section R209.11. The method of contact (for instance, email, regular mail or fax) should be determined by individual offices according to their internal procedures.
...
- the employer withdraws their offer of employment in writing before the issuance of the [work permit](/en/immigration-refugees-citizenship/corporate/publications-manuals/operational-bulletins-manuals/temporary-residents/foreign-workers/eligibility/employer-specific-labout-market-impact-assessment-exemptions.html)[Footnote i](#fn1) and the work permit application is therefore refused
...
If a work permit application is refused, a [refund](/en/immigration-refugees-citizenship/corporate/publications-manuals/operational-bulletins-manuals/fees/refunds.html) of the employer compliance fee should be initiated by the processing office in accordance with the standard guidelines.
...
Employers who are exempt from the fee requirement under [subsection 303.1(5)](http://laws-lois.justice.gc.ca/eng/regulations/SOR-2002-227/section-303.1.html) are required to upload “proof of fee exemption” in the Employer Portal if they indicate they are fee exempt.
...
The proof of fee exemption document may be found in the “eDocs” view tab. Officers should confirm that no fee exemption was indicated and no fee payment was made before refusing under paragraph [R200(2)(f.1)](https://laws-lois.justice.gc.ca/eng/regulations/SOR-2002-227/section-200.html).

### Withdrawal of the offer of employment before work permit issuance

Employers can withdraw only offers of employment that have not yet been matched with a work permit application. Once a work permit application is matched with the offer, the employer must email the [Employer Portal mailbox](mailto:IRCC.EmployerPortal-Portailemployeur.IRCC@cic.gc.ca) indicating that they wish to withdraw.
...
:   “Work permit issuance” is when the officer prints the work permit and gives it to the applicant.
    ...
    [Return to footnote i referrer](#fn1-rf)
